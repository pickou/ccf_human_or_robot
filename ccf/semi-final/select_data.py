...
for i in range(0,2):
    j=0
    flag=0
    saved=open('./data/{0}_ip_camp_{1}.csv'.format(fname[i],j),'w')
    if(i==0):
        saved.write(','.join(header)+'\n')
    else:
        saved.write('row_number,'+','.join(header)+'\n')
    if(i==0):#train
        SELECTED=[0,1,2,3,4,7,21,22] #train
            ...
            with open(f, 'r') as origin:
                ...
                while True:
                    ...
                    for line in lines:
                        ...
                        instance[-2]=instance[-2][:6]#slice born_time to day
                ...
                while True:
                    ...
                    for line in lines:
                        ...
                        if(flag==0):
                            ...
                            flag=1
                        instance=[line[x] for x in SELECTED]
                        instance[-1]=instance[-1][:6]#slice born_time to day
