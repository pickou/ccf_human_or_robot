...
INPUTS_train = [r'./data/train_ip_camp_{0}.csv'.format(i) for i in range(2,3)]
INPUTS_test =[r'./data/test_ip_camp_{0}.csv'.format(i) for i in range(0,2)]
OUTPUTS_ = [[r'./data/train-time_{0}'.format(i) for i in range(2,3)],[ r'./data/test-time_{0}'.format(i) for i in range(0,2)]]
